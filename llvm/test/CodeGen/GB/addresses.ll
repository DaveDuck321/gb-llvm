...
; GBI-O0-NEXT:    ld (hl), a
; GBI-O0-NEXT:    jr z, .LBB2_4
; GBI-O0-NEXT:    jr .LBB2_3
; GBI-O0-NEXT:  .LBB2_3:
; GBI-O0-NEXT:    ld hl, sp, 22
; GBI-O0-NEXT:    ld a, (hl)
; GBI-O0-NEXT:    ld hl, sp, 14
; GBI-O0-NEXT:    ld (hl), a
; GBI-O0-NEXT:    jr .LBB2_4
; GBI-O0-NEXT:  .LBB2_4:
; GBI-O0-NEXT:    ld hl, sp, 11
; GBI-O0-NEXT:    ld a, (hl)
; GBI-O0-NEXT:    ld hl, sp, 14
...
; GBI-O0-NEXT:    ld (hl), a
; GBI-O0-NEXT:    jr z, .LBB2_6
; GBI-O0-NEXT:    jr .LBB2_5
; GBI-O0-NEXT:  .LBB2_5:
; GBI-O0-NEXT:    ld hl, sp, 22
; GBI-O0-NEXT:    ld a, (hl)
; GBI-O0-NEXT:    ld hl, sp, 10
; GBI-O0-NEXT:    ld (hl), a
; GBI-O0-NEXT:    jr .LBB2_6
; GBI-O0-NEXT:  .LBB2_6:
; GBI-O0-NEXT:    ld hl, sp, 15
; GBI-O0-NEXT:    ld e, (hl)
; GBI-O0-NEXT:    inc hl
...
; GBI-O3-NEXT:    jr .LBB2_3
; GBI-O3-NEXT:  .LBB2_3:
; GBI-O3-NEXT:    ld hl, sp, 3
; GBI-O3-NEXT:    ld d, (hl)
; GBI-O3-NEXT:    jr .LBB2_4
; GBI-O3-NEXT:  .LBB2_4:
...
; GBI-O3-NEXT:    ld e, a
; GBI-O3-NEXT:    cp $00
; GBI-O3-NEXT:    jr z, .LBB2_6
; GBI-O3-NEXT:    jr .LBB2_5
; GBI-O3-NEXT:  .LBB2_5:
; GBI-O3-NEXT:    ld hl, sp, 3
; GBI-O3-NEXT:    ld a, (hl)
; GBI-O3-NEXT:    ld hl, sp, 5
; GBI-O3-NEXT:    ld (hl), a
; GBI-O3-NEXT:    jr .LBB2_6
; GBI-O3-NEXT:  .LBB2_6:
; GBI-O3-NEXT:    ld hl, sp, 7
; GBI-O3-NEXT:    ldi a, (hl)
; GBI-O3-NEXT:    ld h, (hl)
